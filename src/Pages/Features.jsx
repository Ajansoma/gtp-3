...
const Features = () => {
  return (
    <div className="relative" id="#features">
      <div className="absolute w-60 h-52 bg-bg-filterC rounded-full -left-10 bottom-5 filter blur-[60px] -z-5 "></div>
        ...
        <div className="grid  gap-10 lg:grid-cols-2">
          ...
          <div className="">
            <Feature
              ...
              titleSize="text-base -mt-5 sm:mt-0 sm:text-lg"
            ...
            <Feature
              ...
              className="grid grid-cols-2 gap-8 items-center mb-5"
              titleSize="text-base sm:text-lg -mt-5 sm:mt-0"
              bodySize="text-xs sm:text-sm"
            />
            <Feature
              ...
              className="grid grid-cols-2 gap-8 items-center mb-5"
              titleSize="text-lg -mt-5 sm:mt-0  sm:text-lg "
              bodySize="text-xs sm:text-sm"
            />
          </div>
        </div>
